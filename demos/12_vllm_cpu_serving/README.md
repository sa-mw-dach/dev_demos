...
- Testing the deployed model
    ...
    - Open a terminal and call the model via 'curl -X POST -H "Content-Type: application/json" -d '{"model":"tinyllama" ,"prompt": "Hello, how are you?"}' http://tinyllama-1b-cpu-predictor.tinyllama.svc.cluster.local:8080/v1/completions | jq'
